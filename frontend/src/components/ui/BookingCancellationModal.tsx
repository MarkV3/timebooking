        ...
        <Card className="border-0">
          ...
          <CardContent className="p-6 space-y-6">
            <div className="bg-muted rounded-lg p-4 space-y-3">
              ...
              <p className="text-sm text-muted-foreground"><strong>Service:</strong> {serviceName}</p>
              <p className="text-sm text-muted-foreground"><strong>Date:</strong> {appointmentDate}</p>
            </div>

            <div className="space-y-2">
              <label htmlFor="cancellation-reason" className="text-sm font-medium text-foreground">Reason for cancellation (optional)</label>
              <textarea
